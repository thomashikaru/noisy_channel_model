...
\begin{itemize}[leftmargin=1.6em,itemsep=1pt]
  \item \textbf{Form} (fixed). The inner character pair-HMM \eqref{eq:char-dp} is run with a
        ...
        deletion---pays a single sharpness $\mathrm{SUB\_FORM\_LP} = \log(1/26)$ (a transposition is
        determined, hence free). The emission \eqref{eq:char-channel} now scores only the \emph{shape}
