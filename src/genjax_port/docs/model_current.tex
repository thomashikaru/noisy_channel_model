...
weight is a marginal step-likelihood, and a rejuvenation kernel that revisits earlier words---and
refreshes the edit rates from their conjugate posterior---as later context disambiguates them.
...
that powers rejuvenation, deduplication over the redundant post-resample particle set, candidate
generation, and the calibration of the action prior against a battery of plausible/implausible
sentence pairs.
