...
Usage: python bd_mem_probe.py "<sentence>" <P>
Matches the cluster config: channel=align, rejuv=gibbs+bd, band=2, max_dist=2, rejuv_lookback=6,
bd_mode=gibbs, bd_funcwords=on, bd_bridge_j=0 (default -> bridges OFF), dedup=on.
"""
...
print(f"RESULT sentence={sentence!r} P={P} Kc={Kc} Wmax={Wmax} LCTX~{LCTX} "
      f"grid_forwards={Wmax*Kc} runtime_s={dt:.1f} peak_rss_GB={peak_gb:.2f}", flush=True)
